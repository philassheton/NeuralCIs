...
LEARNING_RATE_HALF_LIFE_EPOCHS = 100

USE_DECREASE_LEARNING_RATE_ON_PLATEAU = True
LEARNING_RATE_PLATEAU_PATIENCE = 3
LEARNING_RATE_DECAY_RATIO_ON_PLATEAU = 0.5
...
# Monotonic net stuff
MONOTONIC_WITH_PARAMS_HIDDEN_LAYERS = 7
MONOTONIC_WITH_PARAMS_NEURONS_PER_HIDDEN_LAYER = 20
