...
# Param sampling
PARAM_FEELER_MARKOV_CHAIN_LENGTH = 5000
PARAM_FEELER_NUM_CHAINS = 1000
PARAM_FEELER_PERIPHERAL_BATCH_SIZE = 100000                                      # Set as high as your GPU can handle
PARAM_FEELER_PERIPHERAL_BATCHES = 10
PARAM_MARKOV_CHAIN_STEP_SIZE = 1.
PARAM_FEELER_KNOWN_PARAM_MARKOV_CHAIN_SD = .1  # Will combine with step size
PARAM_FEELER_SAMPLES_PER_TEST_PARAM = 100
PARAM_FEELER_SAMPLE_PARAM_IF_SAMPLE_PERCENTILE = 99.95
CDF_FEELER_SAMPLES_PER_TEST_PARAM = 1000 # 100
CDF_FEELER_PARAMS_PER_BATCH = 500#0
